...
class __TwigTemplate_fde8df10fb5757507928b48627aec62f extends Template
{
    private $source;
    private $macros = [];
...
<div style=\"width: 50%; margin-top: 50px\" class=\"container\">
    ...
    <form action=\"";
        ...
        // line 26
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 26, $this->source); })()), "getImage", [], "any", false, false, false, 26), "html", null, true);
        echo "\">
...
";
    ...
    {
        return array (  107 => 26,  100 => 22,  90 => 15,  82 => 10,  77 => 8,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
...
<div style=\"width: 50%; margin-top: 50px\" class=\"container\">
    ...
    <form action=\"{{ path('dashboard.edit', {id: id}) }}\" enctype=\"multipart/form-data\" method=\"POST\">
        ...
        <div class=\"mt-4\" style=\"display: flex; align-items: center;\">
            <img style=\"width: 50%; max-width: 150px\" src=\"{{ product.getImage }}\">
